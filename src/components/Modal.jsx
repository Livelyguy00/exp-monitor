        ...
        <div className='modalWindow__content'>
          <form id='expenseForm'>
            <div className='form-row align-items-center mx-4 py-5'>
              <FormInput name='date' previousValue={previousValues.date} type='date' label='Data' onChange={value => setDate(value)} colSize={2}  />
              <FormInput name='category' previousValue={previousValues.category} type='text' label='Kategoria' onChange={value => setCategory(value)} colSize={3} />
              <FormInput name='description' previousValue={previousValues.description} type='text' label='Opis' onChange={value => setDescription(value)} colSize={4} />
              <FormInput name='value' previousValue={previousValues.cost} type='number' label='Koszt' onChange={value => setCost(value)} colSize={2} />
